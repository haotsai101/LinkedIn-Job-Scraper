...
| 7 | **T50** ✅ CLOSED (#71) — structured `work_history` in `user_profile.json`. **T51** 🔜 OPEN (code merged #73, live QA 2026-09-11 found the account-wall gap → **T52**, blocking). **T52** 🔜 OPEN P1 — `_try_register` is fully built but never called; blocks T51's live QA and account auto-creation on every ATS, not just Workday. | in progress |
...
**Phase:** apply-quality · **Risk:** medium (drives real submissions on a new ATS family) · **Depends on:** T50 (closed) · **Blocked on:** T52 · **Status:** 🔜 **OPEN — code merged (#73), live QA in progress** · **Sev:** P2 · Filed 2026-09-10 (owner choice: "Let's do C for now" — see the Workday options discussed the same session).
...
**Phase:** apply-quality (blocks T51 live QA) · **Risk:** medium (creates real external accounts under the applicant's real email) · **Status:** 🔜 **OPEN** · **Sev:** P1 · Found 2026-09-11 during T51's live Workday QA (2/2 jobs blocked at the account wall for this reason).
