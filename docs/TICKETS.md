...
**Phase:** T40 follow-up · **Risk:** low · **Status:** ✅ fixed (PR pending) · **Sev:** P3 · Found verifying **T40** (PR #41, merged `01354fd`) against the live `user_profile.json`.
