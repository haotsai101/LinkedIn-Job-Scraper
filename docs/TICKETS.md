...
**Phase:** browser-stability (split out of T32) · **Risk:** low–medium · **Status:** ✅ fixed (PR pending) · **Sev:** P3 · Observed in live QA runs (`Locator.count: Target crashed`, `TargetClosedError: Target page, context or browser has been closed`) on memory-heavy ATS SPAs.
