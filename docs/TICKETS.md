...
**Phase:** OffsiteApply reliability · **Risk:** low · **Status:** open · **Sev:** P2 · Found by the T39/T40/T42 combined apply-QA (`apply_jobs.py --auto --limit 20 --verbose`, 2026-09-07), job 8 (Lumenalta "Senior AI Fullstack Software Engineer", `lumenalta.com/jobs/.../apply`).
